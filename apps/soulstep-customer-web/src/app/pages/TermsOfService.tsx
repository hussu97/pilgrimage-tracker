    ...
    <div className="max-w-4xl mx-auto px-4 py-10">
      ...
      <section className="mb-8">
        ...
        <div className="rounded-2xl border border-slate-100 dark:border-dark-border bg-white dark:bg-dark-surface p-5">
          <p className="text-sm text-text-secondary dark:text-dark-text-secondary mb-4">
            ...
            and our mobile applications (collectively, the &quot;Service&quot;), you agree to be bound
            by these Terms of Service (&quot;Terms&quot;). If you do not agree to these Terms, you may
            not access or use the Service.
          </p>
          <p className="text-sm text-text-secondary dark:text-dark-text-secondary">
            These Terms constitute a legally binding agreement between you and SoulStep. By creating an
            account, checking in at a location, submitting a review, or otherwise using any feature of
      ...
      <section className="mb-8">
        ...
        <div className="rounded-2xl border border-slate-100 dark:border-dark-border bg-white dark:bg-dark-surface p-5">
          ...
          <p className="text-sm text-text-secondary dark:text-dark-text-secondary">
            The Service is available through our website and mobile applications for iOS and Android.
            While the core discovery features are available without an account, certain features such
            as check-ins, reviews, favorites, journey groups, and notifications require a registered
            account.
          </p>
        </div>
      </section>
      ...
      <section className="mb-8">
        ...
        <div className="rounded-2xl border border-slate-100 dark:border-dark-border bg-white dark:bg-dark-surface p-5">
          ...
          <p className="text-sm text-text-secondary dark:text-dark-text-secondary mb-4">
            ...
            manipulating reviews, check-in counts, journey leaderboards, or any other Service feature
            is prohibited and may result in the suspension or termination of all associated accounts.
          </p>
          <p className="text-sm text-text-secondary dark:text-dark-text-secondary">
            ...
            if you suspect any unauthorized use of your account. SoulStep is not liable for any loss or
      ...
      <section className="mb-8">
        ...
        <div className="rounded-2xl border border-slate-100 dark:border-dark-border bg-white dark:bg-dark-surface p-5">
          <p className="text-sm text-text-secondary dark:text-dark-text-secondary mb-4">
            ...
            grant SoulStep a worldwide, non-exclusive, royalty-free, perpetual license to use, display,
            reproduce, and distribute your User Content in connection with the operation of the
            Service. This license continues even if you delete your account, to the extent that your
            User Content has been shared with or relied upon by other users.
          </p>
          <p className="text-sm text-text-secondary dark:text-dark-text-secondary mb-4">
            You represent and warrant that your User Content is truthful, based on genuine personal
            experience, and does not infringe on the intellectual property or other rights of any third
            party. Reviews must reflect your honest assessment of the place you visited. Fake reviews,
            reviews of places you have not visited, and reviews submitted in exchange for compensation
      ...
      <section className="mb-8">
        ...
        <div className="rounded-2xl border border-slate-100 dark:border-dark-border bg-white dark:bg-dark-surface p-5">
          ...
          <ul className="text-sm text-text-secondary dark:text-dark-text-secondary mb-4 list-disc list-inside space-y-2">
            ...
            <li>
              Attempt to gain unauthorized access to any part of the Service, other user accounts, or
              any systems or networks connected to the Service
            </li>
            <li>
              Use the Service to promote commercial products, services, or political campaigns without
      ...
      <section className="mb-8">
        ...
        <div className="rounded-2xl border border-slate-100 dark:border-dark-border bg-white dark:bg-dark-surface p-5">
          <p className="text-sm text-text-secondary dark:text-dark-text-secondary mb-4">
            The SoulStep platform, including its design, code, branding, logos, and documentation, is
            the property of SoulStep and is protected by applicable intellectual property laws. You may
            not copy, modify, distribute, or create derivative works of any part of the Service without
            our express written permission.
          </p>
          <p className="text-sm text-text-secondary dark:text-dark-text-secondary">
            Place data displayed on the Service is sourced from third-party providers including Google
            Maps, OpenStreetMap, Wikipedia, and Wikidata, and is subject to their respective licenses
            and terms of use. SoulStep does not claim ownership of third-party place data. The public
            API provides access to this data under the{' '}
            <a
      ...
      <section className="mb-8">
        ...
        <div className="rounded-2xl border border-slate-100 dark:border-dark-border bg-white dark:bg-dark-surface p-5">
          ...
          <p className="text-sm text-text-secondary dark:text-dark-text-secondary">
            ...
            Service. We do not restrict access to the Service based on the use of ad blockers, but some
            ad-supported features may not function as intended.
          </p>
        </div>
      </section>
      ...
      <section className="mb-8">
        ...
        <div className="rounded-2xl border border-slate-100 dark:border-dark-border bg-white dark:bg-dark-surface p-5">
          ...
          <p className="text-sm text-text-secondary dark:text-dark-text-secondary mb-4">
            SoulStep does not guarantee the accuracy, completeness, or timeliness of place information
            displayed on the Service, including but not limited to opening hours, addresses, contact
            information, prayer times, and directions. Place data is sourced from third-party providers
            and user contributions, and may contain errors or become outdated. You should always verify
            critical information (such as opening hours and accessibility) directly with the place
            before visiting.
          </p>
          <p className="text-sm text-text-secondary dark:text-dark-text-secondary">
      ...
      <section className="mb-8">
        ...
        <div className="rounded-2xl border border-slate-100 dark:border-dark-border bg-white dark:bg-dark-surface p-5">
          ...
          <p className="text-sm text-text-secondary dark:text-dark-text-secondary">
            In no event shall SoulStep&apos;s total aggregate liability to you for all claims arising
            from or related to your use of the Service exceed the greater of fifty United States
            dollars (US$50) or the total amount you have paid to SoulStep (if any) during the twelve
      ...
      <section className="mb-8">
        ...
        <div className="rounded-2xl border border-slate-100 dark:border-dark-border bg-white dark:bg-dark-surface p-5">
          <p className="text-sm text-text-secondary dark:text-dark-text-secondary mb-4">
            ...
            these Terms. Upon termination, your right to use the Service will immediately cease, and
      ...
      <section className="mb-8">
        ...
        <div className="rounded-2xl border border-slate-100 dark:border-dark-border bg-white dark:bg-dark-surface p-5">
          <p className="text-sm text-text-secondary dark:text-dark-text-secondary mb-4">
            ...
            will update the &quot;Last updated&quot; date at the top of this page and may provide
            additional notice through the Service. Your continued use of the Service after any changes
            to these Terms constitutes your acceptance of the revised Terms.
          </p>
          <p className="text-sm text-text-secondary dark:text-dark-text-secondary">
      ...
      <section className="mb-8">
        ...
        <div className="rounded-2xl border border-slate-100 dark:border-dark-border bg-white dark:bg-dark-surface p-5">
          <p className="text-sm text-text-secondary dark:text-dark-text-secondary">
            ...
            regard to conflict of law principles. Any disputes arising out of or relating to these
            Terms or the Service shall first be attempted to be resolved through good-faith
