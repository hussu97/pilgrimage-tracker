import type { Place, PlaceDetail, User, Religion, Review, ReviewsResponse, CheckIn, UserStats, Group, LeaderboardEntry, ActivityItem, Notification, UserSettings } from '@/types';
