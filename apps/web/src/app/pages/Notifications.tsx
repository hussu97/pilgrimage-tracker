    ...
    <div className="min-h-screen bg-surface-tint max-w-md md:max-w-2xl mx-auto px-4 py-6 pb-24 md:pb-6">
      ...
      {!loading && !error && notifications.length === 0 && (
        <EmptyState
          ...
          description="When you get check-ins or group updates, they’ll show here."
          action={
            ...
            >
              <div className="flex gap-3 p-4">
                ...
                <div className="min-w-0 flex-1">
                  <p className="font-medium text-text-main">{notificationTitle(n)}</p>
                  {notificationBody(n) && (
                    <p className="text-sm text-text-muted mt-0.5">{notificationBody(n)}</p>
                  )}
