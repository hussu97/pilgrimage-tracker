...
function FilterChip({ label, selected = false, className = '', ...props }: FilterChipProps) {
  return (
    <button
      ...
      className={`whitespace-nowrap px-4 py-2 rounded-full text-xs font-bold border transition-all active:scale-95 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 ${
        selected
