...
export function TimingCircle({ item }: TimingCircleProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-2 min-w-[72px] group">
      <div
        className={`w-[72px] h-[72px] rounded-full border-2 flex flex-col items-center justify-center p-1 transition-all duration-500 transform group-hover:scale-105 active:scale-95 relative ${
          isCurrent
      ...
      >
        <span
          className={`text-[9px] font-bold uppercase tracking-wider leading-tight text-center ${
        ...
        {item.time && (
          <span
            className={`text-sm font-bold leading-tight text-center mt-0.5 ${
