...
- **Group:** group_code (PK, autogenerated), name, description, created_by_user_code (FK), invite_code (for joining), is_private, created_at, **path_place_codes** (optional ordered list of place_codes for “X/Y sites” progress and “next place”).
