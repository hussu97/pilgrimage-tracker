...
**Production hosting:** GCP e2-micro VM (catalog-api + scraper-api + PostgreSQL 15, Docker Compose) · GHCR (images) · Vercel (Web + Admin) · GCS (Images) · Cloud Run Job (Playwright scraper, ephemeral)
