...
- Background ops: `start-local-bg` stores local run bundles/DB/logs under `soulstep-scraper-api/local-handoffs/`; `finalize-bg` stores refreshed finalize bundles and catalog-sync logs there too.
